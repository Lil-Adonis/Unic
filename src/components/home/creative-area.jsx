...
const creative_contents = {
  ...
  title: (
    <>
      We are group of students who are <b>passionate</b> about <b>creating</b>{" "}
      and <b>implementing innovative</b> solutions to various problems in the
      society.
    </>
  ),
  ...
  creative_box: [
    ...
    },
    {
      ...
      box_title: "5+",
      box_text: "Done projects",
    },
  ],
};

const { shape_1, creative_shapes, title, video_id, creative_box } =
  creative_contents;
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="tp-creative-box text-center">
                  <div className="tp-creative-content mb-200">
