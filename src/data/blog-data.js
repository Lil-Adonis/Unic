const blog_data = [
  {
    ...
    short_desc:"At Unic we specialize in creating, building, shipping and scaling beautiful, usable products with blazing-fast",
    duration:'.6s',
    delay:'.4s',
    home:true,
  },
  {
    ...
    comment:'09',
    views:'2,226',
    title:'How to grow your business with Unic',
    short_desc:"At Collax we specialize in creating designing, building, shipping and scaling beautiful, usable products with blazing-fast",
    duration:'.7s',
    delay:'.6s',
    home:true,
  },
